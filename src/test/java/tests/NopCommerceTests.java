...
//        loginPage.Login(uniqueEmail, Config.getProperty("validPassword"));
...
//homePage.logout();
//homePage.clickLoginButton();
//loginPage.Login(uniqueEmail,Config.getProperty("invalidPassword"));
...
//    homePage.setCategoryselect("Electronics");
